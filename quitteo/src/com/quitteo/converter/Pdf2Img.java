...
public class Pdf2Img {
    public static PdfPreview createPreviewImages(byte pdfData[]) {

        // Get a file from the command line to open
        //String filePath = "/Users/juliendurand/Downloads/fiche.pdf";

        // open the url
        Document document = new Document();
        try {
            document.setByteArray(pdfData, 0, pdfData.length, "");
        ...
        for (int i = 0; i < document.getNumberOfPages(); i++) {
            ...
            try {
                ...
                preview.pages.add(baos.toByteArray());
            } catch (IOException e) {
                e.printStackTrace();
            }
            image.flush();
